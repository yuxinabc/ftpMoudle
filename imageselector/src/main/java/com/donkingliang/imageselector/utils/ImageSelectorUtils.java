...
import com.donkingliang.imageselector.ImageUploadActivity;
...
public class ImageSelectorUtils {
    ...
    public static void openPhotoUpload(Activity activity, int maxSelectCount,UploadListener listener) {
        ImageUploadActivity.openActivity(activity,maxSelectCount,listener);
    }
    public interface UploadListener {
        void load(List<String> iamges);
    }
}
